                ...
                <table>
                    <thead>
                        <tr>
	                        ...
	                        <g:sortableColumn property="questionType" title="${message(code: 'question.questionType.label', default: 'QuestionType')}" />
                        
                            <g:sortableColumn property="sequence" title="${message(code: 'question.sequence.label', default: 'Sequence')}" />
                    ...
                    <g:each in="${questionInstanceList}" status="i" var="questionInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: questionInstance, field: "sequence")}</td>
